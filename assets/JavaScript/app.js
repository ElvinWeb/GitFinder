...
const app = (function () {
  ...
  return {
    init() {
      ...
      this.updateProfile(apiUrl);
      followerTabBtn.addEventListener("click", this.updateFollowerRepositories);
      forkedTabBtn.addEventListener("click", this.updateForkRepositories);
      followingTabBtn.addEventListener("click", this.updateFollowingRepositories);
